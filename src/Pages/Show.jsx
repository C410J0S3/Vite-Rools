...
//Img
import RR2 from '../img/2022.1.jpg'
import Cullinan from '../img/culinan.jpg'
import Spectre from '../img/spectre.jpg'
import Phanton from '../img/Ph.jpg'
import Ghost from '../img/404.webp'
      ...
      >
        ...
        <Card to='/Cullinan/ApresentationCullinan' as={motion(Link)}
          ...
          <Card to='*' as={motion(Link)}
            ...
            <motion.h1
            whileHover={{ scale: 1.2 }}>Em Breve</motion.h1>
